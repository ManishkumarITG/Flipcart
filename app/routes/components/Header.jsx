      ...
      <div className="bg-flipkart-blue text-white">
        <div className="max-w-[1400px] mx-auto px-3 sm:px-4 py-2">
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="flex-1 min-w-0 max-w-xl mx-2 sm:mx-4 order-last sm:order-none w-full sm:w-auto mt-2 sm:mt-0">
              <form
                action="/search"
                method="get"
                className="flex bg-white rounded overflow-hidden h-9 sm:h-10"
              >
                <input
                  type="search"
                  name="q"
                  ...
                  className="flex-1 min-w-0 px-3 sm:px-4 text-gray-800 text-sm placeholder:text-gray-400 focus:outline-none"
                  aria-label="Search products"
                />
                <button
                  type="submit"
                  className="bg-flipkart-blue px-4 sm:px-5 flex items-center justify-center shrink-0"
                  aria-label="Search"
                >
          ...
          >
            <nav className="py-4 space-y-1 border-t border-gray-100">
              ...
              <div className="border-t border-gray-100 mt-3 pt-3">
                ...
                <Link to="/sell" className="block px-3 py-2 text-gray-700" onClick={() => setMobileMenuOpen(false)}>
                  Become a Seller
                </Link>
              </div>
            </nav>
